...
object PhysicsToolsTest {
    ...
    fun checkThrustCalculations() {
        ...
        assertEquals(17000f, PhysicsTools.calculateMaxJetThrust(17, 101325f, 288.15f), 100f)
        assertEquals(16490f, PhysicsTools.calculateMaxJetThrust(17, 97698.71f, 286.111f), 100f)
        assertEquals(12070f, PhysicsTools.calculateMaxJetThrust(17, 69706f, 268.333f), 100f)
        assertEquals(8330f, PhysicsTools.calculateMaxJetThrust(17, 46608.56f, 248.889f), 100f)
        assertEquals(5610f, PhysicsTools.calculateMaxJetThrust(17, 30130.09f, 229.444f), 100f)

        // Delta set at 5th significant figure
        assertEquals(77261.88f, PhysicsTools.calculateMaxPropThrust(7562, 26.40509f, 50f, 101325f, 288.15f), 1f)
        assertEquals(30162.31f, PhysicsTools.calculateMaxPropThrust(7562, 26.40509f, 240f, 101325f, 288.15f), 1f)
        assertEquals(62192.316f, PhysicsTools.calculateMaxPropThrust(7562, 26.40509f, 50f, 46563f, 248.526f), 1f)
        assertEquals(29779.682f, PhysicsTools.calculateMaxPropThrust(7562, 26.40509f, 240f, 46563f, 248.526f), 1f)
    }
