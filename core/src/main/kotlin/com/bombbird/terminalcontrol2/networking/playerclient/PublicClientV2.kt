...
class PublicClientV2(private val relayGatewayHost: RelayGatewayHost): NetworkClient(), NetworkRelayClient {
    ...
    override fun beforeConnect(roomId: Short?) {
        ...
        val ciphertext = encryptor.encryptWithIV(iv, com.bombbird.terminalcontrol2.networking.relaygateway.RelayNonce(authResponse.nonce))?.ciphertext ?: return
    ...
    @Synchronized
    override fun decodeRelayMessageObject(data: ByteArray) {
        val obj = fromSerializedBytes(data) ?: return
        onReceiveNonRelayData(obj)
    }

    override fun requestToJoinRoom() {
