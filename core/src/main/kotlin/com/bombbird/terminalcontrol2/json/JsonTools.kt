...
interface BaseComponentJSONInterface {
    enum class ComponentType {
        ...
        APPROACH_INFO, LOCALIZER, LINE_UP_DIST, WAKE_INHIBIT, GLIDE_SLOPE, STEP_DOWN, CIRCLING, MINIMUMS, VISUAL, VISUAL_AFTER_FAF,
        AIRPORT_INFO, RUNWAY_INFO, METAR_INFO, RANDOM_METAR_INFO, WAYPOINT_INFO, AIRCRAFT_INFO, ARRIVAL_AIRPORT, DEPARTURE_AIRPORT,
        CONTROLLABLE, FLIGHT_TYPE, WAITING_TAKEOFF, CONTACT_FROM_TOWER, CONTACT_TO_TOWER, CONTACT_FROM_CENTRE, CONTACT_TO_CENTRE,
        ACCELERATE_TO_ABOVE_250KTS, DECELERATE_TO_240KTS, APP_DECELERATE_TO_190KTS, DECELERATE_TO_APP_SPD, PENDING_CLEARANCES,
        CLEARANCE_ACT, LATEST_CLEARANCE_CHANGED, CLEARANCE_ACT_CHANGED, INITIAL_ARRIVAL_SPAWN, RECENT_GO_AROUND,
        PENDING_CRUISE_ALTITUDE, DIVERGENT_DEPARTURE_ALLOWED, G_POLYGON, POSITION, CUSTOM_POSITION, DIRECTION, SPEED, ALTITUDE,
        ACCELERATION, INDICATED_AIR_SPEED, GROUND_TRACK, AFFECTED_BY_WIND, ON_GROUND, RUNWAY_CHILDREN,  APPROACH_CHILDREN,
        VISUAL_APPROACH, DEPENDENT_OPPOSITE_RUNWAY, DEPENDENT_PARALLEL_RUNWAY, CROSSING_RUNWAY, DEPARTURE_DEPENDENCY,
        ARRIVAL_ROUTE_ZONE, DEPARTURE_ROUTE_ZONE, ACTIVE_LANDING, ACTIVE_TAKEOFF, RANDOM_AIRLINE_DATA, ACTIVE_RUNWAY_CONFIG,
        ARRIVAL_CLOSED, TIME_SINCE_LAST_DEPARTURE, DEPARTURE_INFO, AIRPORT_NEXT_DEPARTURE, RUNWAY_PREVIOUS_ARRIVAL,
        ...
        CUSTOM_APPROACH_SEPARATION_CHILDREN, PARALLEL_WAKE_AFFECTS, AIRPORT_ARRIVAL_STATS
    }
...
private fun getPolymorphicComponentAdapter(): PolymorphicJsonAdapterFactory<BaseComponentJSONInterface> {
    ...
    return PolymorphicJsonAdapterFactory.of(BaseComponentJSONInterface::class.java, "componentType")
        ...
        .withSubtype(VisualAfterFaf::class.java, BaseComponentJSONInterface.ComponentType.VISUAL_AFTER_FAF.name)
        ...
        .withSubtype(NeedsToInformOfGoAround::class.java, BaseComponentJSONInterface.ComponentType.NEEDS_TO_INFORM_OF_GO_AROUND.name)
