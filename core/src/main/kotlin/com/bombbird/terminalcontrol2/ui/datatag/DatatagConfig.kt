...
class DatatagConfig(val name: String) {
    ...
    /**
     * Generates the text to be displayed on the datatag, using the given [fields]
     * and checking if the datatag [isMinimized], whether it is undergoing [wakeTurbulence],
