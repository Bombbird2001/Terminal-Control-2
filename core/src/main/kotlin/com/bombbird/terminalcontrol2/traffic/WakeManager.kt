        ...
        conflictAbles.forEach {
            ...
            fun checkWakeConflictForAircraftInSector(sector: GdxArray<WakeZone>): Boolean {
                for (i in 0 until sector.size) sector[i]?.apply {
                    ...
                    // Check that aircraft altitude is between 50 and 950 feet below the wake altitude
                    if (alt.altitudeFt > wakeAlt.altitudeFt - 50 || alt.altitudeFt < wakeAlt.altitudeFt - 950) return@apply
